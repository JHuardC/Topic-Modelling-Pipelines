...
from scripts.functions.tuning_pipelines import GensimPipeline, TuningPipeline
import logging
...
hyperparameters = {
    ...
    'model__num_topics': list(range(0, 10, 2))
}
...
model_coherences = grid_search.gridsearch(petitions['combined'])
